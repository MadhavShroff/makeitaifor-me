  ...
  return (
    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-wrap justify-between">
        ...
        <div className="w-full md:w-2/12 mb-8 md:mb-0 flex flex-col items-start md:items-end">
          ...
          <p className="mt-8 text-right">MakeIt<span className="text-black-500">Ai</span>For.<span className="text-black-500">Me</span></p>
        </div>
      </div>
    </div>
    </footer>
