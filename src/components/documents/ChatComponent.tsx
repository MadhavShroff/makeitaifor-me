...
const Modal = () => {
  const gotoCognitoSignIn = () => {window.location.href = cognitoHostedUI};

  return (<div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-30">
