  ...
  return (
    <Html lang="en">
      <Head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Sora:wght@100;200;300;400;700;800&display=swap"
          rel="stylesheet"
        />
        <meta property="og:title" content="Make It AI For Me" />
        <meta
          property="og:description"
          content="Empowering your business with cutting-edge AI solutions. Join us on the journey to automation and efficiency."
        />
        <meta
          property="og:image"
          content="https://www.makeitaifor.me/icons/icon512.png"
        />
