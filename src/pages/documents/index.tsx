...
const Documents = () => {
  ...
  useEffect(() => {
    ...
    //     });
    // }
    setDocs(["Hello Hi", "How", "Are", "You", "Doing", "Today", "On", "Madhav_Shroff_Resume_.pdf", "https://source.boringavatars.com/marble/50/HelloHi?colors=EF233C,FED4E7,313638,003E1F", "Day asdoiascobida ascoiasdofiadoi ascpinapdfinpief ZOIBzObaiasdnasdpinaspfi apsncpainfapsncaof  asonanof pasnodpaosd poansdcs pihIBIPOBPIBas.onasd"]);
  }, [user]);
